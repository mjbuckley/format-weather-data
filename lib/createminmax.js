...
function createMinMax(obj) {
  ...
  for(let prop in obj) {
    valuesArray["annInchPlus"].push(obj[prop]["annInchPlus"]);
    valuesArray["annGndInchPlus"].push(obj[prop]["annGndInchPlus"]);
    valuesArray["annprcpge050hi"].push(obj[prop]["annprcpge050hi"]);
    valuesArray["mlyTMaxAvg"].push(obj[prop]["mlyTMaxAvg"][12]);
    valuesArray["mlyTMinAvg"].push(obj[prop]["mlyTMinAvg"][12]);
    valuesArray["daysBelow32"].push(obj[prop]["daysBelow32"]);
  };
